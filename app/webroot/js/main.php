...
{
show_div(500);
html += "<div id='popup3' class='forgot-pass'  style='width: 400px;' > <div id='close'><a href='javascript:hidebglayer();'><img src='<?php echo IMAGE_DIR; ?>close.png' width='38' height='38' border='0' /></a></div><div style='float: left;position: absolute;margin-top: 40px;margin-left: 40px;'><div style=''><h1 style='float: left; width: 326px;'> Forgot Password ?</h1><label style='float: left;margin-top: 16px;margin-right: 20px;'>Email Id</label><input style='float: left;margin-top: 13px;' type='text' name='fpass_emailid' id='fpass_emailid' placeholder='Email Id' value='Email Id' onfocus='javascript: if(this.value == \"Email Id\"){ this.value = \"\"; }' onblur='javascript: if(this.value==\"\"){this.value=\"Email Id\";}'/><div id='rsp_fpass_emailid' style='float: left; width: 314px;'></div></div><input type='button' name='forgot_pass' value='&nbsp;' class='submit4' style='float: left;margin-left: 68px;margin-top: 10px;' onclick='send_reset_link();'></div></div>";
}
else if(statusshow=="sentmail")
{
show_div(531);
html += "<div id='popup3'><div id='close3'><a href='javascript:hidebglayer();'><img src='<?php echo IMAGE_DIR; ?>close.png' width='38' height='38' border='0' /></a></div><div style='height:60px;'></div><h1><img src='<?php echo IMAGE_DIR; ?>error.gif' width='53' height='53' style='margin-bottom:-20px;' />Email Sent Sucessfully.</h1></div>";
}
...
{
how_div(531);
html += "<div id='popup3'><div id='close3'><a href='javascript:hidebglayer();'><img src='<?php echo IMAGE_DIR; ?>close.png' width='38' height='38' border='0' /></a></div><div style='height:60px;'></div><h1><img src='<?php echo IMAGE_DIR; ?>error.gif' width='53' height='53' style='margin-bottom:-20px;' />Email not Sent Sucessfully.</h1></div>";
}
...
var html = "";
show_div(32);
html = "<image src='inc/images/loader.gif' style='padding-top:150px;'/>";
document.getElementById("SWFContainerDIV").innerHTML = "";
document.getElementById("SWFContainerDIV").innerHTML = html;
